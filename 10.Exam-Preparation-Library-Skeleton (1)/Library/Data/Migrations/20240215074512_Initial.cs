        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "Book category")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CollectorId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Collector of the book identifier"),
                    BookId = table.Column<int>(type: "int", nullable: false, comment: "Book that was collected identifier")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBooks", x => new { x.CollectorId, x.BookId });
                    table.ForeignKey(
